...
export default function Page() {
    ...
    const generateDoc = async () => {
        try {
            ...
            //instructor name
            const iName =
                instructorId === 14 ? process.env.INSTRUCTOR_NAME : "XYZ";
            //instructor licence
            const iLicence =
                instructorId === 14 ? process.env.INSTRUCTOR_LICENCE : "XYZ";
            //instructor expiry date
            const iExpiry =
                instructorId === 14
                    ? process.env.INSTRUCTOR_LICENCE_EXPIRY
                    : "XYZ";
            //ontario licence
            const oLicence =
                instructorId === 14 ? process.env.ONTARIO_LICENCE : "XYZ";

            // Set the template variables
            doc.setData({
                // @ts-ignore
                firstName: records[0].student.firstName,
                // @ts-ignore
                lastName: records[0].student.lastName,
                address:
                    // @ts-ignore
